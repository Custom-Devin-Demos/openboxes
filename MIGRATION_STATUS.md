...
| 2-receiving | receiving batch | IN_PROGRESS | [4a653a78](https://app.devin.ai/sessions/4a653a786b034b85833923f00bd8b085) | [#59](https://github.com/Custom-Devin-Demos/openboxes/pull/59) | partialReceiving + receiveOrderWorkflow 3-step React wizard (4 new /api/receiveOrder endpoints); conflicts with develop (localizations/messages/urls.js) — child rebasing additively; CI blocked by conflict (only pr-formatter ran) |
