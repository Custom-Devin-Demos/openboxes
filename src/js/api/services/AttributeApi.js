import {
  ...
  ATTRIBUTES,
  ATTRIBUTES_SEARCH,
  UNIT_OF_MEASURE_CLASS_OPTIONS,
} from 'api/urls';
import apiClient from 'utils/apiClient';

export default {
  searchAttributes: (config) => apiClient.get(ATTRIBUTES_SEARCH, config),
  ...
  getUnitOfMeasureClassOptions: (config) =>
    apiClient.get(UNIT_OF_MEASURE_CLASS_OPTIONS, config),
};
