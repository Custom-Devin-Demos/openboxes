...
const OrderListFilters = ({
  ...
  const filtersToIgnore = supportedActivities.includes('ENABLE_CENTRAL_PURCHASING') ? ['destinationParty', 'orderType'] : ['destination', 'orderType'];
  ...
  return (
    <div className="d-flex flex-column list-page-filters">
      <FilterForm
        ...
        allowEmptySubmit
        searchFieldDefaultPlaceholder="Search by order number or description"
        searchFieldPlaceholder="react.order.searchField.placeholder.label"
        hidden={false}
      />
    </div>
  );
...
export default connect(mapStateToProps)(OrderListFilters);
