/**
 * Minimal HTTP client with JSESSIONID session-cookie auth, following the same
 * conventions as api-snapshots/src/client.js (kept separate so the two
 * harnesses stay independent). Requires Node >= 18 (global fetch).
 */
